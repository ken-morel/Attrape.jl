function apply_layout!(component::AttrapeComponent, widget)
    ...
    !isnothing(component.halign) && Mousetrap.set_horizontal_alignment!(widget, getproperty(Mousetrap.Alignment, component.halign))
    return !isnothing(component.valign) && Mousetrap.set_vertical_alignment!(widget, getproperty(Mousetrap.Alignment, component.valign))
end
