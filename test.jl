...
const media_page = Page(page"""
    Box box=V margin="10x10" halign=center valign=center expand=true
...
Application("com.julia.widget-showcase") do ctx
    page"""
        Box box=H
            Box box=V size="150x0" margin="5x5"
